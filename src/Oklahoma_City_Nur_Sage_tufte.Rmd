...
### Calibrating Friction Functions
...
For our scenario, we modeled what would happen if Oklahoma ceded to the demands of the Land Back Movement and returned sovereignty and control of a considerable amount of land that was stolen from the Creek, Seminole, and Kickapoo communities in the seven land runs that occurred between 1889 and 1906^[National Cowboy and Western Heritage Museum, [Rushes to Statehood: The Oklahoma Land Runs ](https://nationalcowboymuseum.org/explore/rushes-statehood-oklahoma-land-runs/)] (land was stolen from many other nations in Oklahoma but are outside our study area). 
...
This scenario is concerned with the area of Oklahoma City contained within the Land Run of 1895. We geolocated the map in Figure \@ref(fig:land-rush-map) to identify which census tracts would become part of the new urban center. In total, six tracts with a total area of 353 square miles were included. 
...
```{r hbo-scenario-dot, echo=F, fig.cap="Home Based Other productions and attractions in the Land Back Scenario.", fig.dim=c(10,10)}
hbo_dots
```
...
``` {r congestion-map-scenario, fig.cap="Road Congestion at 5pm in Oklahoma City under the proposed Land Back scenario. Orange and Red links show where the number of vehicles (v) exceeds the capacity (c) of the road"}
knitr::include_graphics("../graphics/scenario/okc_congestion_scenario.png")
```
