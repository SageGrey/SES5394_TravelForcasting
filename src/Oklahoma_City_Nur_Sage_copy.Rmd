...
```{r road-network, fig.cap="The modeled Oklahoma City road network.", fig.dim=c(10,10)}
...
```{r transit-inset, fig.margin=T, fig.cap="Full county map with public transit.", fig.width=5}
knitr::include_graphics("../graphics/a4/Rplot.png")
```

```{r transit-network, fig.cap="The public transit network in Oklahoma City.", fig.dim=c(1,1)}
knitr::include_graphics("../graphics/a4/BestColor_TransitNetworksClevelandAndOklahoma.png")
```
...
``` {r employment-tree, fig.cap="Majority of employment in OKC metro area is in the service industry.", fig.dim=c(4,3)}
...
``` {r vehicle-density, fig.cap="The few households with 0 vehicles are concentrated around Downtown and the University of Oklahoma.", fig.dim=c(5,5)}
