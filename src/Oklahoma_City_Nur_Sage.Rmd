...
<center>
![**Fig 9**: Transit accessibility scores for each zone (on a log scale)](../graphics/a5/trans_access_log.png){width=70%}
</center>
...
<center>
![**Fig 10**: Transit accessibility scores for each zone (on a log scale)](../graphics/a5/trans_access_linear.png){width=70%}
</center>

Those outliers can also be seen in Figure 11 at the far right tail of the distribution.  

<center>
![**Fig 11**: Distribution of zone accessibility scores](../graphics/a5/Transit_Histogram.png){width=60%}
</center>
...
![**Fig A6**:Highest income neighborhoods are north of downtown](../graphics/a2/median_income_map.png){width=40%} 

![**Fig A7**: Income, Population Density, and Adults Living with their Parents](../graphics/a2/structure_income_density.png){width=30%} 