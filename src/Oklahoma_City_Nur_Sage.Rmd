...
![*Fig 2: OKC Road Network*](../graphics/a3/modified_network.png){width=30%} 
...
![*Fig 3: OKC Public Transit Network*](../graphics/a4/Rplot.png){width=40%}
...
### **Population, Activity & Employment Densities**

<center>

![](../graphics/a2/num_households.png){width=60%}

![Total Employment](../graphics/a2/total_emp.png){width=40%} ![Employment Breakdown](../graphics/a2/employment.png){width=30%}

![Employment Density](../graphics/a2/empl_density.png){width=40%}![Activity Density](../graphics/a2/act_density.png){width=40%}
